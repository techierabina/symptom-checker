...
VAGUE_INPUTS = [
    ...
    "i am feeling good", "i feel good", "i feel fine",
    "i am fine", "i am okay", "i am ok"
]
...
"""
    ...
    has_mild_flag = any(flag in text for flag in MILD_FLAGS)
    if has_mild_flag:
        return """
**Severity: ✅ MILD**
**Reason: Mild symptom detected**

**Recommended action:** Rest at home, stay hydrated, monitor your symptoms.
